...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(pushButton_export, 2, 2, 1, 1);
        ...
        label_sts = new QLabel(centralwidget);
        label_sts->setObjectName(QString::fromUtf8("label_sts"));

        gridLayout->addWidget(label_sts, 1, 0, 1, 2);
